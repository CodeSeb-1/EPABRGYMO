function toggleRequestor() {
    ...
    const otherRequestorDetails = document.getElementById('otherRequestorDetails');
    ...
    const requestorType = document.querySelector('input[name="requestor"]:checked').value;
